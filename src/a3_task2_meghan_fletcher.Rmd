...
**Note: You should get a warning about one piece dropped. What happens to the name in Row 49, which contains two dashes? The last part of the name is missing...
...
```{r}
# Your code here: 
some_dates <- c(04011996, 02181997, 07061995)
...
storms_danger <- storms %>% 
  mutate(danger = case_when(
    status == c("hurricane") ~ "high",
    status %in% c("tropical depression", "tropical storm") ~ "moderate"))
